...
celery_app.conf.update(
    # task_always_eager=True, # Flags for sync/async execution, useful for testing and debugging
    # task_eager_propagates=True, # Flags for sync/async execution, useful for testing and debugging
    task_acks_late=True,
